...
fn menu_click_activates_item() {
    ...
    let width = 80u16;
    let col = 2u16;
    let me = fileZoom::input::mouse::MouseEvent { column: col, row: 0, kind: fileZoom::input::mouse::MouseEventKind::Down(fileZoom::input::mouse::MouseButton::Left) };
...
fn command_line_toggle_preview() {
    ...
    app.command_line = Some(CommandLineState { visible: true, buffer: String::new(), cursor: 0 });
